...
public class CottonCandyLog extends ATimeBlock{
	...
	public CottonCandyLog(Material mat, String tex, String name, float hard, float resist, SoundType sound) {
		super(mat);
    ...
    {
        return p_149691_1_ == 1 ? this.iconLogTop : (p_149691_1_ == 0 ? this.iconLogTop : this.blockIcon);
    }
