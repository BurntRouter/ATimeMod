...
public class ATimeLog extends ATimeBlock {
	@SideOnly(Side.CLIENT)
	private IIcon iconLogTop;
	@SideOnly(Side.CLIENT)
	private IIcon iconLogSide;

	public ATimeLog(Material mat, String tex, String name, float hard,
	...
	public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
		return p_149691_1_ == 1 ? this.iconLogTop
				: (p_149691_1_ == 0 ? this.iconLogTop : this.blockIcon);
	}
	...
	public void registerBlockIcons(IIconRegister p_149651_1_) {
		this.blockIcon = p_149651_1_.registerIcon(this.getTextureName()
				+ "_side");
		this.iconLogTop = p_149651_1_.registerIcon(this.getTextureName()
				+ "_top");
	}
}