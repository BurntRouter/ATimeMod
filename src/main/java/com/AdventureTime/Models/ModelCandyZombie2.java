...
public class ModelCandyZombie2 extends ModelBase
{
    ModelRenderer leg_1;
    ModelRenderer leg_2;
    ModelRenderer shoe_3;
    ModelRenderer face;
    ...
    public ModelCandyZombie2()
    {
        this.textureWidth = 256;
        this.textureHeight = 64;
        this.leg_1 = new ModelRenderer(this, 5, 5);
        this.leg_1.addBox(0.0F, 0.0F, 0.0F, 1, 7, 1);
        ...
        this.leg_2.addBox(0.0F, 0.0F, 0.0F, 1, 7, 1);
        ...
        this.shoe_3 = new ModelRenderer(this, 13, 9);
        this.shoe_3.addBox(0.0F, 0.0F, 0.0F, 2, 1, 1);
        this.shoe_3.setRotationPoint(-3.0F, 23.0F, 0.0F);
        this.shoe_3.setTextureSize(256, 64);
        this.shoe_3.mirror = true;
        this.setRotation(this.shoe_3, 0.0F, ((float)Math.PI / 2F), 0.0F);
        this.face = new ModelRenderer(this, 151, 10);
        this.face.addBox(0.0F, 0.0F, 0.0F, 9, 10, 10);
        this.face.setRotationPoint(-4.5F, 2.0F, 3.5F);
        ...
        this.body_1.addBox(0.0F, 0.0F, 0.0F, 8, 3, 10);
        this.body_1.setRotationPoint(-4.5F, 12.0F, 3.0F);
        ...
        this.body_2.addBox(0.0F, 0.0F, 0.0F, 8, 10, 3);
        this.body_2.setRotationPoint(5.5F, 1.5F, 3.0F);
        ...
        this.body_3.addBox(0.0F, 0.0F, 0.0F, 8, 4, 10);
        this.body_3.setRotationPoint(-4.5F, -2.0F, 3.0F);
        this.body_3.setTextureSize(256, 64);
        this.body_3.mirror = true;
        this.setRotation(this.body_3, 0.0F, ((float)Math.PI / 2F), 0.0F);
        this.shoe_1 = new ModelRenderer(this, 9, 9);
        this.shoe_1.addBox(0.0F, 0.0F, 0.0F, 2, 1, 1);
        this.shoe_1.setRotationPoint(3.0F, 23.0F, 0.0F);
        this.shoe_1.setTextureSize(256, 64);
        this.shoe_1.mirror = true;
        this.setRotation(this.shoe_1, 0.0F, ((float)Math.PI / 2F), 0.0F);
        this.shoe_4 = new ModelRenderer(this, 13, 9);
        this.shoe_4.addBox(0.0F, 0.0F, 0.0F, 1, 1, 1);
        this.shoe_4.setRotationPoint(-3.0F, 22.0F, -1.0F);
        this.shoe_4.setTextureSize(256, 64);
        this.shoe_4.mirror = true;
        this.setRotation(this.shoe_4, 0.0F, 0.0F, 0.0F);
        this.shoe_2 = new ModelRenderer(this, 13, 9);
        this.shoe_2.addBox(0.0F, 0.0F, 0.0F, 1, 1, 1);
        this.shoe_2.setRotationPoint(3.0F, 22.0F, -1.0F);
        this.shoe_2.setTextureSize(256, 64);
        this.shoe_2.mirror = true;
        this.setRotation(this.shoe_2, 0.0F, 0.0F, 0.0F);
        this.body_4 = new ModelRenderer(this, 50, 0);
        this.body_4.addBox(0.0F, 0.0F, 0.0F, 8, 10, 3);
        this.body_4.setRotationPoint(-7.5F, 1.5F, 3.0F);
        ...
        this.hand_1.addBox(0.0F, 0.0F, 0.0F, 1, 13, 1);
        this.hand_1.setRotationPoint(-8.0F, 7.0F, -1.0F);
        ...
        this.hand_2.addBox(0.0F, 0.0F, 0.0F, 1, 13, 1);
        this.hand_2.setRotationPoint(8.0F, 7.0F, -1.0F);
        ...
        this.face_peace_1.addBox(0.0F, 0.0F, 0.0F, 2, 2, 8);
        this.face_peace_1.setRotationPoint(-6.5F, -0.5F, -5.0F);
        ...
        this.face_peace_2.addBox(0.0F, 0.0F, 0.0F, 2, 2, 8);
        this.face_peace_2.setRotationPoint(5.5F, -0.5F, -5.0F);
        ...
        this.face_peace_3.addBox(0.0F, 0.0F, 0.0F, 2, 2, 8);
        this.face_peace_3.setRotationPoint(5.5F, 11.5F, -5.0F);
        ...
        this.face_peace_4.addBox(0.0F, 0.0F, 0.0F, 2, 2, 8);
        this.face_peace_4.setRotationPoint(-6.5F, 11.0F, -5.0F);
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        this.shoe_3.render(f5);
        this.face.render(f5);
        this.body_1.render(f5);
        this.body_2.render(f5);
        this.body_3.render(f5);
        this.shoe_1.render(f5);
        this.shoe_4.render(f5);
        this.shoe_2.render(f5);
